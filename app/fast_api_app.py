...
# GCP-specific setup (only when running on Vertex AI / Google Cloud)
...
app.title = "ai-finance-memory"
app.description = "API for interacting with the Agent ai-finance-memory"
